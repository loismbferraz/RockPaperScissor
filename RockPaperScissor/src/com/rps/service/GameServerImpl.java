...
public class GameServerImpl implements GameServer{
    ...
    @Override
    public void createGame(final Player player1, final Player player2, final String nrRoundsStr){
        Integer nrRounds = Integer.parseInt(nrRoundsStr);
        this.game = new Game(player1, player2, nrRounds);
    ...
    public void playGame(){
        ...
        while (i<=game.getRounds()){
            ...
            Choice pl1Choice = player1.generateChoice();
            Choice pl2Choice = player2.generateChoice();
            ...
            if(pl1Choice.equals(pl2Choice)){
                ...
                boolean isPl2Winner = pl1Choice.isWonBy(pl2Choice);
                if(isPl2Winner)
                {
        ...
        Result res = new Result(winner, plays);
        this.game.setResult(res);
    }

    @Override
    public void resumeGame(){
        Result res = this.game.getResult();

        String winner = res.getWinnersName();
        System.out.println("=====================================");
        System.out.println("             GAME RESUME             ");
        System.out.println("=====================================");
        System.out.println("Round"+ " - " + this.game.getPlayer1().getName() + " - " + this.game.getPlayer2().getName());
